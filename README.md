...
This repository is building toward **MVP 0.1: Private World/Campaign Wiki**. The current app foundation includes Supabase magic-link auth, first-workspace creation, worlds, campaigns, and Markdown entries.
